//The `use` statement imports stuff into the current namespace.
...
fn main() {
    //The double colons below is syntax for calling into a module namespace,
...
//This is where your define what data your Model contains.
...
//You get the Model instance as an argument to the function, so for instance if you have defined 
// your Model to contain data about circles, this is the function where you use that data to set 
...
fn view(app: &App, _model: &Model, frame: Frame){
    ...
    //The `draw` instance is the current drawing context.
    let draw = app.draw();

    //Use the draw-instance background function and set the color.
    draw.background()
        .color(CYAN);

    //Use the draw instance to draw a pink ellipse
    draw.ellipse()
        .color(PINK); //Set the color using a color constant.
